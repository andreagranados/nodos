...
class dt_cargo extends toba_datos_tabla
{
   ...
   function get_listado2($id_nodo=null){
       ...
       $sql="select *,gasto+difer as gastotot from ("
               . "select *,case when costosub is not null then costosub-costo_basico else 0 end as difer,case when puesto='A' or puesto='P' or puesto='M' then costo_basico else 0 end as credito,"
