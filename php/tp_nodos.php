<?php
 class tp_nodos extends toba_tp_basico
  ...
  protected $clase_encabezado = 'encabezado';	
	...
	function post_contenido()
	{
		...
		echo "<div class='login-pie'>";
                $anio=date('Y');
		echo "<div style='font-size:10px;'>Desarrollado por <strong>".toba_recurso::imagen_proyecto('DTI_LOGO.png',true,'60','30')."</strong><br>Universidad Nacional del Comahue</div>
			<div >2022 - ".$anio."</div>";
		echo "</div>";
	}
